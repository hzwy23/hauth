...
(function($){
    ...
    //
    //     function genTreeUI(a){
    //         var odivStyle='cursor:pointer;background-color: '+__DEFAULT.bgColor+';padding:0px 0px 0px 10px;text-align: left !important;width: '+__DEFAULT.width+'; border:'+__DEFAULT.border+'; height: '+__DEFAULT.height+'; line-height: '+__DEFAULT.height+';display:inline-block; border-radius:'+__DEFAULT.borderRadius+''
    //         var odiv = '<div class="HshowSelectValue" style="'+odivStyle+'">' +
    //             '<span style="height: '+__DEFAULT.height+'; font-size: '+__DEFAULT.fontSize+'; overflow: hidden;word-break:keep-all;white-space:nowrap; text-overflow:ellipsis; display: inline-block;">'+__DEFAULT.placeholder+'</span>' +
    //             '<hzw style="position: absolute;width: 20px;right: 16px; float: right;height: '+__DEFAULT.height+'; line-height: '+__DEFAULT.height+';">' +
