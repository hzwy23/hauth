        ...
        Hmodal:function(param){
            ...
            function init(){
                var mframe='<div class="modal-dialog">'+
                    ...
                    '<button type="button" class="close h-modal-close" data-dismiss="modal" aria-hidden="true" style="height: '+__DEFAULT.headerHeight+'; line-height: '+__DEFAULT.headerHeight+'; width: 30px; padding-top: 2px;">×</button>'+
